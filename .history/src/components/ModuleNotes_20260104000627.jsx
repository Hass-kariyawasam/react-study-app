...
<span className="flex items-center gap-1.5 px-2.5 py-0.5 rounded-md bg-slate-100 dark:bg-slate-800 text-xs font-semibold text-slate-600 dark:text-slate-400 mt-1">
...
<a 
             ...
             >
<LinkIconLucide size={14} /> {res.title} <ExternalLink size={10} className="opacity-50"/>
</a>
))}
</div>
)}
</div><div className="prose prose-slate dark:prose-invert max-w-none">
      {currentModule.notes}
    </div>
  </div>
</div>);
