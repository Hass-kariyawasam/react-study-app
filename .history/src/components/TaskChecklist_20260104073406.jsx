        ...
        <div className="p-6 space-y-3">
          {currentDay?.checklist?.map((task, idx) => (
            ...
            >
              ...
              <span className={`text-sm font-medium leading-snug transition-colors ${completedSubTasks[`${activeDay}-${idx}`] ? 'text-slate-400 line-through' : 'text-slate-700 dark:text-slate-300'}`}>
                {task}
              </span>
            </label>
          ))}
